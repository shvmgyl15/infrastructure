...
with open('../infrastructure/rabbitmq/definitions.json') as f:
    customDefination = json.load(f)

# Open the existing json file for ConsentManager
with open(definationFile) as f:
...
# Write back to the defination in infrastructure
with open('../infrastructure/rabbitmq/definitions.json', 'w') as f:
    json.dump(customDefination, f)